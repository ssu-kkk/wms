...
def binder(client_socket, addr):
  ...
  try:
    ...
    while True:
      ...
      #pisound 
      input_sound = "/home/pi/input_voice.mp3"
      output_sound = "/home/pi/output_voice.mp3"

      if(msg == compare_iunput):
          #filename = 'input_voice.mp3'
          pygame.mixer.music.load(input_sound)
          pygame.mixer.music.set_volume(1.0)
          pygame.mixer.music.play()

      if(msg == compare_output):
          #filename = 'output_voice.mp3'
          pygame.mixer.music.load(output_sound)
          pygame.mixer.music.set_volume(1.0)
          pygame.mixer.music.play()
...
server_socket.bind(('192.168.0.93', 9091));
